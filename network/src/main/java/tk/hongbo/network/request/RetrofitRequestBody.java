...
public class RetrofitRequestBody extends RequestBody {
    ...
    public RetrofitRequestBody(RequestBody requestBody, ResponseCallback callback) {
        this(requestBody, callback, callback.getTag());
    }

    public RetrofitRequestBody(RequestBody requestBody, ResponseCallback callback, Object tag) {
    ...
    public RetrofitRequestBody setTag(Object tag) {
        Tag = tag;
        return this;
    }
